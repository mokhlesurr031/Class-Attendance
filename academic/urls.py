...
urlpatterns = [
    ...
    path('create-section', views.add_section, name="create-section"),
    path('create-session', views.add_session, name="create-session"),
    path('create-shift', views.add_shift, name="create-shift"),
